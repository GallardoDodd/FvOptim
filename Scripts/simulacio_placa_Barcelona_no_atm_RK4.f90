...
OPEN(unit=10, file="Dades/metode_Rk4/sense_atmosfera/Coordenades_orbita_no_atm.txt", status="replace")
DO i = 1,n
...
OPEN(unit=10, file="Dades/metode_Rk4/sense_atmosfera/evo_declinacio_no_atm.txt", status="replace")
OPEN(unit=20,file="Dades/metode_Rk4/sense_atmosfera/elevacio_solar_anual_no_atm.txt", status="replace")
DO i = 1,n
...
DO i = 1,n
  ...
  END IF
END DO
OPEN(unit=10, file="Dades/metode_Rk4/sense_atmosfera/intensitats_N_no_atm.txt", status="replace")
DO i = 1,n
